...
$(document).ready(function(){
    ...
    const mostraMsgMes = (texto) =>{
        ...
        switch(texto){
            case "3/10": titulo = "03 de Outubro de 2017"; mensagem = "<p>Esse foi o dia do nosso primeiro beijo rs. </p><p>Nós dois com vergonha, quem diria que seria o único beijo que eu ia querer pelo resto da minha vida.</p><p> Você é incrível!</p>";break;
            case "3/3": titulo = "03 de Março de 2018"; mensagem = "<p>O dia mais feliz da minha vida. O dia que eu te pedi em namoro! </p><p>Depois que terminamos, eu recrio todos os dias esse dia na minha cabeça, com pensando quando irei reviver esse momento historico novamente. Meu maior sonho é te assumir pra todo mundo e te chamar de minha namorada</p>";break; 
        }
